...
// 1. Pindahkan seluruh logika Form ke dalam komponen terpisah
function LoginForm() {
  ...
  // Amankan penggunaan search params di dalam komponen tersendiri
...
// 2. Komponen utama yang diexport wajib membungkus LoginForm dengan Suspense
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4 py-12 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8 bg-white p-8 rounded-xl shadow-md border border-gray-100">
        ...
        {/* 🚀 Suspense boundary menyembuhkan error build Vercel */}
        <Suspense fallback={<div className="text-center text-sm text-gray-500">Memuat halaman...</div>}>
          <LoginForm />
        </Suspense>
      </div>
    </div>
